...
namespace BrothelMaster
{
	...
	public ref class cInterfaceEvent
	{
	public:
		cInterfaceEvent() {
			m_Next=nullptr;
	...
	public ref class cInterfaceEventManager
	{
	public:
		literal int EVENT_BUTTONCLICKED = 1;
		literal int EVENT_SELECTIONCHANGE = 2;
		literal int EVENT_CHECKBOXCLICKED = 3;
		literal int EVENT_SLIDERCHANGE = 4;

		cInterfaceEventManager(){
			m_NumEvents=0;m_Events=nullptr;}
		...
		*/
		...
		{
			cInterfaceEvent^ newEvent = gcnew cInterfaceEvent();
