...
namespace WMaster.Concept
{
    ...
    public sealed class GameEngine
    {
        ...
        /// <summary>
        /// Pricate constructor for Singleton template.
        /// </summary>
        private GameEngine()
        { }
        #endregion
        ...
        #region Game date
        private DateTime m_Date = new DateTime(1209, 1, 1);
        /// <summary>
        /// Get or set the current year in game.
        /// </summary>
        public int Year
        {
            get { return this.m_Date.Year; }
            set
            {
                lock (this.m_SyncRoot)
                {
                    if (this.m_Date.Year != value)
                    { this.m_Date = new DateTime(value, this.m_Date.Month, this.m_Date.Day); }
                }
            }
        }
        /// <summary>
        ...
        public int Month
        {
            get { return this.m_Date.Month; }
            set
            {
                lock (this.m_SyncRoot)
                {
                    if (this.m_Date.Month != value)
                    { this.m_Date = new DateTime(this.m_Date.Year, value, this.m_Date.Day); }
                }
            }
        }
        /// <summary>
        ...
        public int Day
        {
            get { return this.m_Date.Day; }
            set
            {
                lock (this.m_SyncRoot)
                {
                    if (this.m_Date.Day != value)
                    { this.m_Date = new DateTime(this.m_Date.Year, this.m_Date.Month, value); }
                }
            }
        }
        #endregion
        ...
        */
        ...
        {
            get { return GangManager.Instance; }
        }
        ...
        {
            throw new NotImplementedException();
            //// Ask player his name, date of birth and brothel name.
            //cScriptManager sm;
