...
namespace WMaster.Concept.GangMission
{
    ...
    public sealed class GangMissionKidnappGirls : GangMissionBase
    {
        ...
        {
            return LocalString.GetString(LocalString.ResourceStringCategory.Global, "GangMissionKidnappGirls");
        }
        ...
        protected override bool PerformingMission()
        {
            ...
            if (WMRand.Percent(Math.Min(75, this.GangCible.Intelligence))) // chance to find a girl to kidnap
            {
                ...
                if (girl != null)
                {
                    ...
                    this.GangCible.m_Events.AddMessage(kidnappMissionEvent.ToString(), ImageTypes.PROFILE, gangEventType);
                }
                else
                {
                    kidnappMissionEvent.AppendLine(
                    ...
                    this.GangCible.m_Events.AddMessage(kidnappMissionEvent.ToString(), ImageTypes.PROFILE, EventType.GANG);
                }
            }
            else
            {
