...
namespace WMaster.Concept.GangMission
{
    ...
    public sealed class GangMissionGrandTheft : GangMissionBase
    {
        ...
        {
            return LocalString.GetString(LocalString.ResourceStringCategory.Global, "GangMissionGrandTheft");
        }
        ...
        protected override bool PerformingMission()
        {
            ...
            if (defenders != null)
            {
                if (!GangManager.GangBrawl(this.GangCible, defenders, false))
                {
                    grandTheftEvent.AppendLine(
                        LocalString.ResourceStringCategory.Global,
                        "YourMenLoseTheFight");
                    this.GangCible.m_Events.AddMessage(grandTheftEvent.ToString(), ImageTypes.PROFILE, EventType.DANGER);
                    return false;
                }
                grandTheftEvent.AppendLine(
                    LocalString.ResourceStringCategory.Global,
            ...
            this.GangCible.m_Events.AddMessage(grandTheftEvent.ToString(), ImageTypes.PROFILE, EventType.GANG);
