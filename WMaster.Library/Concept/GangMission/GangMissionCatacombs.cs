...
namespace WMaster.Concept.GangMission
{
    ...
    public sealed class GangMissionCatacombs : GangMissionBase
    {
        ...
        {
            return LocalString.GetString(LocalString.ResourceStringCategory.Global, "GangMissionCatacombs");
        }
        ...
        protected override bool PerformingMission()
        {
                    ...
                    if (WMRand.Percent((this.GangCible.Intelligence / 4) + 25))
                    {
                        ...
                        if (unique)
                        {
                            ...
                            NGmsg.AppendFormat(LocalString.ResourceStringCategory.Global,
                                ...
                                new List<FormatStringParameter>() { new FormatStringParameter("GirlName", ugirl.m_Realname), new FormatStringParameter("GangName", this.GangCible.Name) });
            ...
            else	// use new code
            {
                ...
                else
                {
                    ...
                    if (totalItems > 0)
                    {
                        if (totalItems == 1)
                        {
                            catacombsMissionEvent.AppendLine(LocalString.ResourceStringCategory.Global, "YourMenBringBackOneItem");
                        }
                        else
                        {
                            catacombsMissionEvent.AppendLineFormat(LocalString.ResourceStringCategory.Global,
            ...
            this.GangCible.m_Events.AddMessage(catacombsMissionEvent.ToString(), ImageTypes.PROFILE, EventType.GANG);
            return true;
        }
    }
}
