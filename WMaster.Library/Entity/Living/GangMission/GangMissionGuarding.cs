...
//<!-- -------------------------------------------------------------------------------------------------------------------- -->
//<file>
//  <copyright file="GangMissionGuarding.cs" company="The Pink Petal Devloment Team">
...
namespace WMaster.Entity.Living.GangMission
{
    ...
    /// <summary>
    /// Guarding mission affecte to gang.
    /// </summary>
    public class GangMissionGuarding : GangMissionBase
    {
        /// <summary>
        /// Initialise base instantce of gang mission.
        /// </summary>
        /// <param name="gang"><see cref="Gang"/> who perform the mission.</param>
        internal GangMissionGuarding(Gang gang)
            : base(EnuGangMissions.Guarding, gang)
        {
        }
        ...
        {
            return LocalString.GetString(LocalString.ResourceStringCategory.GangMission, "MissionGuarding");
        }

        // TODO : Find and move gang guarding mission function ?!?
    }
}
