...
//<!-- -------------------------------------------------------------------------------------------------------------------- -->
//<file>
//  <copyright file="GangMissionSpyGirls.cs" company="The Pink Petal Devloment Team">
...
namespace WMaster.Entity.Living.GangMission
{
    ...
    /// <summary>
    /// Performe a gang spying girls mission.
    /// </summary>
    public class GangMissionSpyGirls : GangMissionBase
    {
        /// <summary>
        /// Initialise base instantce of gang mission.
        /// </summary>
        /// <param name="gang"><see cref="Gang"/> who perform the mission.</param>
        internal GangMissionSpyGirls(Gang gang)
            : base(EnuGangMissions.SpyGirls, gang)
        {
        }
        ...
        {
            return LocalString.GetString(LocalString.ResourceStringCategory.GangMission, "MissionSpyGirls");
        }

        // TODO : Find and move gang spying girls mission function ?!?
    }
}
