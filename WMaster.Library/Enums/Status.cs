...
//<!-- -------------------------------------------------------------------------------------------------------------------- -->
//<file>
//  <copyright file="Status.cs" company="The Pink Petal Devloment Team">
...
namespace WMaster.Enums
{
    ...
    public enum Status
    {
        ...
        /// <summary>
        /// 1 more than the last status.
        /// </summary>
        [Obsolete("The NUM_STATUS enum value of eStatus must be replace by enum extention function returning the number of value in enum. Enum value must be only enum value!", false)]
