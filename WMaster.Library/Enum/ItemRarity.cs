...
//<!-- -------------------------------------------------------------------------------------------------------------------- -->
//<file>
//  <copyright file="ItemRarity.cs" company="The Pink Petal Devloment Team">
...
namespace WMaster.Enum
{
    ...
    public enum ItemRarity
    {
        ...
        [Obsolete("The NUM_ITEM_RARITY enum value of eItemRarity must be replace by enum extention function returning the number of value in enum. Enum value must be only enum value!", false)]
        NUM_ITEM_RARITY
    };
}
