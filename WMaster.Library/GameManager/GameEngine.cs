...
using WMaster.ClassOrStructurToImplement.HFileToImport;
using WMaster.GameConcept.Item;
using WMaster.Tool;

namespace WMaster.GameManager
{
    /// <summary>
    ...
    public sealed class GameEngine
    {
        ...
        {
            get { return GameEngine.Game.g_Year; }
            set { GameEngine.Game.g_Year = value; }
        }
        /// <summary>
        ...
        {
            get { return GameEngine.Game.g_Month; }
            set { GameEngine.Game.g_Month = value; }
        }
        /// <summary>
        /// Current day in game.
        /// </summary>
        ...
        {
            get { return GameEngine.Game.g_Day; }
        ...
        */
        ...
        // Girl manager
        public cGirls g_Girls = new cGirls();

        // Brothel Manager
        public cBrothelManager g_Brothels = new cBrothelManager();

        // Gang Manager
        private cGangManager g_Gangs = new cGangManager();

        // Customer Manager
        private cCustomers g_Customers = new cCustomers();

        // Clinic Manager
        private cClinicManager g_Clinic = new cClinicManager();

        // Movie Studio Manager
        private cMovieStudioManager g_Studios = new cMovieStudioManager();

        // Arena Manager
        private cArenaManager g_Arena = new cArenaManager();

        // Centre Manager
        private cCentreManager g_Centre = new cCentreManager();

        // House Manager
        private cHouseManager g_House = new cHouseManager();

        // Farm Manager
        private cFarmManager g_Farm = new cFarmManager();

        // Inventory manager
        private cInventory g_InvManager = new cInventory();

        // The global trigger manager
        private cTriggerList g_GlobalTriggers = new cTriggerList();
 
        // Trait list
        cTraits g_Traits = new cTraits();
        #endregion
    }
}
