...
namespace WMaster.ClassOrStructurToImplement
{
    public class cGoldBase
    {
         ...
         */
        public void goon_wages(double cost)
        { throw new NotImplementedException(); }
        ...
        public void petty_theft(double income)
        { throw new NotImplementedException(); }
        public void grand_theft(double income)
        { throw new NotImplementedException(); }
        public void catacomb_loot(double income)
        { throw new NotImplementedException(); }
        /*
         ...
         *	from your girls
         */
        public void misc_credit(double amount)
        { throw new NotImplementedException(); }
