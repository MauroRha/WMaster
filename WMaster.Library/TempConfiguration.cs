...
namespace WMaster
{
    ...
    public class TempConfiguration
    {
        ...
        public void Initialise()
        {
            ...
            ResourcesText.Add("GangMissionGuarding", "guarding");
            ResourcesText.Add("GangMissionSabotage", "attacking your rivals");
            ResourcesText.Add("GangMissionSpyGirls", "spying on your girls");
            ResourcesText.Add("GangMissionRecaptureGirls", "trying to recapture a runaway");
            ResourcesText.Add("GangMissionExtortion", "trying to extort new businesses");
            ResourcesText.Add("GangMissionPettyTheft", "performing petty crimes");
            ResourcesText.Add("GangMissionGrandTheft", "performing major crimes");
            ResourcesText.Add("GangMissionKidnappGirls", "trying to kidnap girls");
            ResourcesText.Add("GangMissionCatacombs", "exploring the catacombs");
            ResourcesText.Add("GangMissionTraining", "training");
            ResourcesText.Add("GangMissionRecruit", "recruiting");
            ResourcesText.Add("GangMissionService", "helping the community");
            ResourcesText.Add("GangMissionDungeon", "Doing dungeon mission");
            ResourcesText.Add("GangMissionNone", "doing nothing");
