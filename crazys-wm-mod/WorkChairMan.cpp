...
// `J` Job Clinic - Staff - Matron_Job - Full_Time_Job
bool cJobManager::WorkChairMan(sGirl* girl, sBrothel* brothel, bool Day0Night1, string& summary)
{
...
double cJobManager::JP_ChairMan(sGirl* girl, bool estimate)// not used
{
