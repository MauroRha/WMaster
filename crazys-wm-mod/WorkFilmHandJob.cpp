...
bool cJobManager::WorkFilmHandJob(sGirl* girl, sBrothel* brothel, bool Day0Night1, string& summary)
{
	...
	int finalqual = g_Studios.AddScene(girl, JOB_FILMHANDJOB, bonus);
